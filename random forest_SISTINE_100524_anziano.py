...
# Carica i dati di addestramento
train_file_path = r"C:\Users\ele99\OneDrive\Documenti\Tirocinio\DATA_propotipo\AF3_FeatReduc.xlsx"
df_train = pd.read_excel(train_file_path)
...
# Carica i dati di test (un singolo soggetto)
test_file_path = r"C:\Users\ele99\OneDrive\Documenti\Tirocinio\DATA_propotipo\AF3_A016.xlsx"
df_test = pd.read_excel(test_file_path)
...
print("Scores:", scores)
print(np.mean(MU))
>>>>>>> e18f4167fce6319a3e7cf2348995a16a81eae0d6
